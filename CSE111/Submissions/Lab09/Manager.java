...
public class Manager{
    public static void main(String []args){
        ...
        /** I also created a variable for database length so that the user
         *  can choose how much students he/she wants to add in the database
         *  --The variable is ts
         */
        System.out.print("Kotojon Student bolo: ");
        int ts=k.nextInt();//User will tell how much students she wants to add.
        sd.records = new Student [ts];
        k.nextLine();
        int c=0;
