...
public class Lab_2_Task_1 implements GLEventListener {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        //8
        MidpointLine(gl, -10, 31, -40, 31); //Upper Line
        MidpointLine(gl, -10, -30, -10, 30); //Right Line
        MidpointLine(gl, -10, 0, -40, 0); //Middle Line
        MidpointLine(gl, -10, -30, -40, -30); //Lower Line
        MidpointLine(gl, -41, 30, -41, -29); //Left Line

        //6
        MidpointLine(gl, 10, 31, 39, 31); //Upper Line
        MidpointLine(gl, 10, -30, 10, 30); //Left Line
        MidpointLine(gl, 10, 0, 39, 0); //Middle Line
        MidpointLine(gl, 10, -30, 39, -30); //Lower Line
        MidpointLine(gl, 40, -30, 40, -1); //Right Half Line
    }
    ...
    public static void main(String[] args) {
        ...
        Lab_2_Task_1 l = new Lab_2_Task_1();
        glcanvas.addGLEventListener(l);
        glcanvas.setSize(400, 400);
        //creating frame
        final JFrame frame = new JFrame ("My ID: 19301086");
